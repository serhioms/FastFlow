...
public class TestHighOrderConsumer extends TestBase {
	...
	public void testConsumerZample32() throws InterruptedException {
		...
		Consumer<TestContext> wkf = ConsumerZamples.zample32(sequential, parallel);
	...
	public void testConsumerZample62() throws InterruptedException {
		...
		Consumer<TestContext> wkf = ConsumerZamples.zample6(sequential, parallel);
	...
	public void testConsumerZample8() throws InterruptedException {
		...
		Consumer<TestContext> wkf = ConsumerZamples.zample8(sequential, parallel);
	...
	public void testConsumerZample7() throws InterruptedException {
		...
		Consumer<TestContext> wkf = ConsumerZamples.zample7(sequential, parallel);
	...
	public void testConsumerZample5() throws InterruptedException {
		...
		Consumer<TestContext> wkf = ConsumerZamples.zample5(sequential, parallel);
	...
	public void testConsumerZample4() throws InterruptedException {
		...
		Consumer<TestContext> wkf = ConsumerZamples.zample4(sequential, parallel);
	...
	public void testConsumerZample3() throws InterruptedException {
		...
		Consumer<TestContext> wkf = ConsumerZamples.zample3(sequential, parallel);
	...
	public void testConsumerZample2() throws InterruptedException {
		...
		Consumer<TestContext> wkf = ConsumerZamples.zample2(sequential, parallel);
	...
	public void testConsumerZample1() throws InterruptedException {
		...
		Consumer<TestContext> wkf = ConsumerZamples.zample1(sequential, parallel);
	...
	public void testConsumerZample() throws InterruptedException {
		...
		Consumer<TestContext> wkf = ConsumerZamples.zampleConsumers(sequential, parallel);
